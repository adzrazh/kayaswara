...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .stat-card-primary .stat-icon { background: rgba(140,29,24,0.1); color: var(--primary); }
        ...
        .stat-card-warning .stat-icon { background: rgba(184,134,11,0.1); color: var(--warning); }

        .stat-card-info { --stat-color: var(--secondary); }
        .stat-card-info .stat-icon { background: rgba(26,60,94,0.1); color: var(--secondary); }
        ...
        .color-preview-bar {
            height: 8px;
            background: linear-gradient(90deg, var(--preview-primary, #1A3C5E), var(--preview-secondary, #1A3C5E), var(--preview-accent, #B8860B));
        }
        ...
        .color-preview-btn {
            ...
            font-size: 13px;
            color: #fff;
            background: var(--preview-primary, #1A3C5E);
            margin-right: 8px;
        }

        .color-preview-btn-sec {
            background: var(--preview-secondary, #1A3C5E);
        }

        .color-preview-btn-acc {
            background: var(--preview-accent, #B8860B);
        }
