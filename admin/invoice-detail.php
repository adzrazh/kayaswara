        ...
        <div class="col-xl-8">
            <div class="admin-card mb-4">
                ...
                <div style="padding:24px;">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#9AA7B2;margin-bottom:12px;">Info Invoice</div>
                            <?php foreach ([
                            ...
                            <div style="display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid #EEF3F7;font-size:13px;">
                                <span style="color:#74838E;"><?= $lbl ?></span>
                                <span style="font-weight:600;"><?= $val ?></span>
                            </div>
                            <?php endforeach; ?>
                        </div>
                        <div class="col-md-6">
                            <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#9AA7B2;margin-bottom:12px;">Klien</div>
                    ...
                    <!-- Amount Table -->
                    <div style="margin-top:24px;border:1px solid #DCE5ED;border-radius:10px;overflow:hidden;">
                        <table style="width:100%;border-collapse:collapse;font-size:13px;">
                            ...
                            <tbody>
                                <tr style="border-bottom:1px solid #EEF3F7;">
                                    <td style="padding:12px 16px;font-weight:600;">
                                        ...
                                        <div style="font-size:11px;color:#9AA7B2;margin-top:3px;"><?= htmlspecialchars(mb_substr(strip_tags($order['description']), 0, 100)) ?><?= mb_strlen(strip_tags($order['description'])) > 100 ? '…' : '' ?></div>
                                        <?php endif; ?>
                                    </td>
                            ...
                            <tfoot style="background:#F9FBFD;">
                                <?php if ($inv['discount'] > 0): ?>
                                <tr style="border-top:1px solid #DCE5ED;">
                                    <td colspan="2" style="padding:8px 16px;color:#74838E;">Diskon</td>
                                ...
                                <tr style="border-top:1px solid #DCE5ED;">
                                    <td colspan="2" style="padding:8px 16px;color:#74838E;">PPh 23 (2%)*</td>
                    ...
                    <?php if ($inv['show_pph23'] && $inv['tax_pph23'] > 0): ?>
                    <p style="font-size:11px;color:#9AA7B2;margin-top:8px;margin-bottom:0;">*) PPh 23 dipotong oleh pembeli badan usaha sesuai ketentuan perpajakan.</p>
                    <?php endif; ?>

                    <?php if (!empty($inv['admin_notes'])): ?>
                    <div style="margin-top:16px;padding:12px 16px;background:#F9FBFD;border-radius:8px;border-left:3px solid var(--primary);">
                        <div style="font-size:11px;font-weight:700;color:#9AA7B2;margin-bottom:4px;">CATATAN ADMIN</div>
        ...
        <div class="col-xl-4">
            ...
            <div class="admin-card mb-4">
                ...
                <div style="padding:20px;display:flex;flex-direction:column;gap:10px;">
                    ...
                    <div style="font-size:11px;color:#9AA7B2;word-break:break-all;">
                        Link pelanggan: <a href="<?= htmlspecialchars($pdfUrl) ?>" target="_blank" style="color:var(--primary);"><?= htmlspecialchars($pdfUrl) ?></a>
                    </div>
                    <?php else: ?>
                    <div style="padding:10px 14px;background:#FAF2E0;border-radius:8px;border:1px solid #fcd34d;font-size:13px;color:#7A5A0C;">
            ...
            <div class="admin-card mb-4">
                ...
                <div style="padding:20px;display:flex;flex-direction:column;gap:10px;">
                    ...
                    <div style="font-size:12px;color:#9AA7B2;">Akan dikirim ke: <strong><?= htmlspecialchars($order['client_email']) ?></strong></div>
            ...
            <div class="admin-card">
                ...
                <div style="padding:16px 20px;">
                    <div style="font-size:13px;color:#74838E;margin-bottom:12px;">Minimal DP (50%):</div>
                    <div style="font-size:22px;font-weight:800;color:var(--primary);">
                        Rp <?= number_format((int)ceil($inv['total'] / 2), 0, ',', '.') ?>
                    </div>
                    <div style="font-size:12px;color:#9AA7B2;margin-top:4px;">dari total Rp <?= number_format($inv['total'], 0, ',', '.') ?></div>
                    <?php if ($inv['due_date']): ?>
                    <div style="margin-top:12px;padding:8px 12px;background:#FAF2E0;border-radius:8px;font-size:12px;color:#7A5A0C;">
