...
<div class="admin-content">
    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            ...
            <a href="https://wa.me/<?= $wa_phone ?>?text=Halo%20<?= urlencode($konsultasi['name']) ?>,%20kami%20dari%20Kayaswara."
               target="_blank"
            ...
            <!-- Email -->
            <a href="mailto:<?= htmlspecialchars($konsultasi['email']) ?>?subject=Konsultasi%20Penerbitan%20-%20Tindak%20Lanjut&body=Halo%20<?= urlencode($konsultasi['name']) ?>,%0A%0AKami%20dari%20Kayaswara%20ingin%20menindaklanjuti%20permintaan%20konsultasi%20Anda.%0A%0ASalam,%0ATim%20Kayaswara"
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-8">
            ...
            <!-- File Attachment -->
            <?php if (!empty($konsultasi['attachment_file'])): ?>
            <div class="admin-card mb-4">
                <div class="admin-card-header">
                    <h5 class="admin-card-title">
                        <i class="fas fa-paperclip"></i>
                        File Lampiran Naskah
                    </h5>
                </div>
                <div class="admin-card-body">
                    <?php
                    $filePath = SITE_URL . '/assets/uploads/consultations/' . htmlspecialchars($konsultasi['attachment_file']);
                    $origName = htmlspecialchars($konsultasi['attachment_name'] ?? $konsultasi['attachment_file']);
                    $ext = strtolower(pathinfo($konsultasi['attachment_file'], PATHINFO_EXTENSION));
                    $iconMap = [
                        'pdf' => 'fas fa-file-pdf', 'doc' => 'fas fa-file-word', 'docx' => 'fas fa-file-word',
                        'odt' => 'fas fa-file-alt', 'rtf' => 'fas fa-file-alt', 'txt' => 'fas fa-file-alt',
                        'zip' => 'fas fa-file-archive', 'rar' => 'fas fa-file-archive',
                    ];
                    $icon = $iconMap[$ext] ?? 'fas fa-file';
                    ?>
                    <div style="display:flex;align-items:center;gap:16px;background:#f8fafc;border-radius:10px;padding:16px 20px;border:1px solid #e2e8f0;">
                        <i class="<?= $icon ?>" style="font-size:2rem;color:var(--primary);"></i>
                        <div style="flex:1;">
                            <div style="font-weight:600;font-size:14px;color:#1e293b;"><?= $origName ?></div>
                            <div style="font-size:12px;color:#94a3b8;margin-top:2px;">Format: <?= strtoupper($ext) ?></div>
                        </div>
        ...
        <div class="col-xl-4">
            ...
            <div class="admin-card mb-4">
                ...
                <div class="admin-card-body">
                    ...
                    <?php if (!empty($konsultasi['phone'])): ?>
                    <a href="https://wa.me/<?= $wa_phone ?>?text=Halo%20<?= urlencode($konsultasi['name']) ?>,%20kami%20dari%20Kayaswara%20ingin%20menindaklanjuti%20konsultasi%20Anda%20mengenai%20layanan%20<?= urlencode($service_labels[$konsultasi['service_type']] ?? '') ?>."
                       target="_blank"
                    ...
                    <a href="mailto:<?= htmlspecialchars($konsultasi['email']) ?>?subject=Re:%20Konsultasi%20Penerbitan&body=Halo%20<?= urlencode($konsultasi['name']) ?>,%0A%0A"
