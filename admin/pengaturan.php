                ...
                <div class="row g-4">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" style="background:#F9FBFD;font-size:12px;">+62</span>
                    ...
                    <div class="col-xl-4">
                        <div style="background:linear-gradient(135deg,rgba(26,60,94,0.06),rgba(26,54,93,0.06));border-radius:14px;padding:24px;border:1px solid rgba(26,60,94,0.15);">
                            <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#74838E;margin-bottom:14px;">
                                <i class="fas fa-lightbulb me-1" style="color:#1A3C5E;"></i>
                                Panduan
                            </div>
                            <ul style="font-size:13px;color:#74838E;padding-left:18px;margin:0;line-height:2;">
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" style="font-size:12px;color:#74838E;">Navigasi, heading</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" style="font-size:12px;color:#74838E;">Aksen, tombol sekunder</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" style="font-size:12px;color:#74838E;">CTA, badge highlight</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-2 d-flex align-items-center gap-3">
                                <img src="../assets/uploads/site/<?= htmlspecialchars($settings['logo_path']) ?>"
                                     ...
                                     style="height:60px;max-width:200px;object-fit:contain;border-radius:8px;border:1.5px solid #DCE5ED;padding:8px;background:#fff;">
                            ...
                            <div class="mb-2" id="logoPreviewWrap" style="display:none;">
                                <img id="logoPreview" src="" alt="" style="height:60px;max-width:200px;object-fit:contain;border-radius:8px;border:1.5px solid #DCE5ED;padding:8px;background:#fff;">
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-2">
                                <img src="../assets/uploads/site/<?= htmlspecialchars($settings['favicon_path']) ?>"
                                     ...
                                     style="width:32px;height:32px;object-fit:contain;border-radius:4px;border:1.5px solid #DCE5ED;">
                            </div>
                            <?php else: ?>
                            <div class="mb-2" id="faviconPreviewWrap" style="display:none;">
                                <img id="faviconPreview" src="" alt="" style="width:32px;height:32px;object-fit:contain;border-radius:4px;border:1.5px solid #DCE5ED;">
                            </div>
                            <?php endif; ?>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="color-preview-card" id="colorPreviewCard">
                            ...
                            <div class="color-preview-body">
                                <div style="margin-bottom:16px;">
                                    ...
                                    <p id="previewSubtitle" style="color:#74838E;font-size:13px;margin:0;">
                                ...
                                <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                    ...
                                    <span style="background:#EEF3F7;color:#41525F;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:700;">
                                        Terpercaya
                                    </span>
                                </div>

                                <div style="height:1px;background:#DCE5ED;margin:16px 0;"></div>
                                ...
                                <div style="margin-top:12px;display:flex;gap:8px;">
                                    <!-- Card preview -->
                                    <div style="flex:1;border:1px solid #DCE5ED;border-radius:8px;overflow:hidden;">
                                        ...
                                        <div style="padding:10px;font-size:12px;">
                                            ...
                                            <div style="color:#74838E;font-size:11px;">Instalasi & konfigurasi</div>
                                        </div>
                                    </div>
                                    <div style="flex:1;border:1px solid #DCE5ED;border-radius:8px;overflow:hidden;">
                                        ...
                                        <div style="padding:10px;font-size:12px;">
                                            ...
                                            <div style="color:#74838E;font-size:11px;">Editing & Layout</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="display:flex;gap:8px;margin-top:16px;">
                            <div style="text-align:center;flex:1;">
                                ...
                                <div style="font-size:11px;color:#74838E;">Primer</div>
                            ...
                            <div style="text-align:center;flex:1;">
                                ...
                                <div style="font-size:11px;color:#74838E;">Sekunder</div>
                            ...
                            <div style="text-align:center;flex:1;">
                                ...
                                <div style="font-size:11px;color:#74838E;">Aksen</div>
                    ...
                    <div class="col-xl-8">
                        ...
                        <div style="background:linear-gradient(135deg,rgba(22,163,74,0.06),rgba(26,60,94,0.06));border-radius:14px;padding:20px 24px;margin-bottom:24px;border:1px solid rgba(22,163,74,0.15);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
                            <div style="display:flex;align-items:center;gap:12px;">
                                ...
                                <div>
                                    <div style="font-weight:700;font-size:15px;color:#12212E;">Notifikasi WhatsApp Otomatis</div>
                                    <div style="font-size:12px;color:#74838E;">Kirim update progres pesanan langsung ke WhatsApp klien</div>
                                </div>
                            </div>
...
_Kayaswara_</div>
                        ...
                        <!-- ===== Email / SMTP Settings ===== -->
                        <hr style="margin:28px 0;border-color:#DCE5ED;">
                        ...
                        <div style="background:linear-gradient(135deg,rgba(59,130,246,0.06),rgba(26,60,94,0.06));border-radius:14px;padding:20px 24px;margin-bottom:24px;border:1px solid rgba(59,130,246,0.15);display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
                            <div style="display:flex;align-items:center;gap:12px;">
                                ...
                                <div>
                                    <div style="font-weight:700;font-size:15px;color:#12212E;">Notifikasi Email (SMTP)</div>
                                    <div style="font-size:12px;color:#74838E;">Kirim email konfirmasi pesanan ke klien secara otomatis</div>
                                </div>
                            </div>
                            <div class="form-check form-switch">
                    ...
                    <div class="col-xl-4">
                        <div style="background:linear-gradient(135deg,rgba(22,163,74,0.06),rgba(26,60,94,0.06));border-radius:14px;padding:24px;border:1px solid rgba(22,163,74,0.15);">
                            ...
                            <ol style="font-size:13px;color:#74838E;padding-left:18px;margin:0;line-height:2.2;">
                            ...
                            <div style="font-size:12px;font-weight:700;color:#74838E;margin-bottom:8px;">
                                <i class="fas fa-info-circle me-1"></i> Kapan Notifikasi Dikirim?
                            </div>
                            <ul style="font-size:12px;color:#74838E;padding-left:16px;margin:0;line-height:2;">
                            ...
                            <div style="max-height:200px;overflow-y:auto;">
                                ...
                                <div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid rgba(0,0,0,0.05);font-size:11px;">
                                    ...
                                    <span style="color:#9AA7B2;margin-left:auto;white-space:nowrap;"><?= date('d/m H:i', strtotime($log['created_at'])) ?></span>
                                </div>
                                <?php endforeach; ?>
                            </div>
                            <?php else: ?>
                            <p style="font-size:12px;color:#9AA7B2;margin:0;">Belum ada log notifikasi.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div style="background:#fff;border-radius:14px;border:1px solid #DCE5ED;overflow:hidden;">
                            <div style="padding:18px 24px 0;border-bottom:1px solid #EEF3F7;">
                                <div style="font-size:13px;font-weight:700;color:#12212E;margin-bottom:12px;">
                            ...
                            <div style="padding:24px;background:#F9FBFD;">

                                <!-- Tab: Konfirmasi Pesanan -->
                                <div id="emailTab-konfirmasi">
                                    <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:10px;border:1px solid #DCE5ED;overflow:hidden;font-family:Arial,sans-serif;font-size:14px;color:#374151;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                                        ...
                                        <div style="padding:28px;">
                                            ...
                                            <p style="margin:0 0 16px;color:#74838E;">Terima kasih telah mempercayakan kebutuhan penerbitan buku Anda kepada kami. Pesanan Anda telah berhasil dibuat dengan detail berikut:</p>
                                            <div style="background:#F9FBFD;border-radius:8px;border:1px solid #DCE5ED;padding:16px 20px;margin-bottom:20px;">
                                                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#9AA7B2;margin-bottom:12px;">Detail Pesanan</div>
                                                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                                                    <tr><td style="padding:4px 0;color:#74838E;width:40%;">Kode Tracking</td><td style="padding:4px 0;font-weight:700;color:<?= htmlspecialchars($prev_color) ?>;"><?= $prev_tracking ?></td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Layanan</td><td style="padding:4px 0;font-weight:600;">Penerbitan Buku Lengkap</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Paket</td><td style="padding:4px 0;font-weight:600;">Profesional</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Institusi</td><td style="padding:4px 0;">Universitas Indonesia</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">No. HP/WA</td><td style="padding:4px 0;">081234567890</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Estimasi Biaya</td><td style="padding:4px 0;font-weight:700;">Rp 2.500.000</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Status</td><td style="padding:4px 0;"><span style="background:#FAF2E0;color:#7A5A0C;padding:2px 10px;border-radius:20px;font-size:12px;font-weight:600;">Menunggu</span></td></tr>
                                                </table>
                                            </div>
                                            <div style="background:#f0fdf4;border-radius:8px;border:1px solid #bbf7d0;padding:12px 16px;margin-bottom:20px;font-size:13px;">
                                                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#9AA7B2;margin-bottom:8px;">Deskripsi Kebutuhan</div>
                                            ...
                                            <div style="text-align:center;margin:24px 0;">
                                                ...
                                                <div style="margin-top:10px;font-size:12px;color:#9AA7B2;">Masukkan kode: <strong><?= $prev_tracking ?></strong></div>
                                            </div>
                                            <p style="margin:0;color:#74838E;font-size:13px;">Tim kami akan segera menghubungi Anda untuk konfirmasi lebih lanjut.</p>
                                        </div>
                                        <div style="background:#F9FBFD;padding:16px 28px;text-align:center;border-top:1px solid #DCE5ED;">
                                            <div style="font-size:12px;color:#9AA7B2;">© <?= date('Y') ?> <?= htmlspecialchars($prev_site) ?> — Email otomatis, tidak perlu dibalas.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="emailTab-milestone" style="display:none;">
                                    <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:10px;border:1px solid #DCE5ED;overflow:hidden;font-family:Arial,sans-serif;font-size:14px;color:#374151;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                                        ...
                                        <div style="padding:28px;">
                                            <p style="margin:0 0 16px;">Yth. <strong>Budi Santoso</strong>,</p>
                                            <p style="margin:0 0 20px;color:#74838E;">Kami ingin menginformasikan bahwa salah satu tahapan pesanan Anda telah selesai.</p>
                                            <div style="background:#f0fdf4;border-radius:8px;border:1px solid #bbf7d0;padding:16px 20px;margin-bottom:20px;">
                                                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#9AA7B2;margin-bottom:12px;">Update Pesanan</div>
                                                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                                                    <tr><td style="padding:4px 0;color:#74838E;width:40%;">Kode Tracking</td><td style="padding:4px 0;font-weight:700;color:<?= htmlspecialchars($prev_color) ?>;"><?= $prev_tracking ?></td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Tahapan Selesai</td><td style="padding:4px 0;font-weight:700;">✅ Layout & Typesetting</td></tr>
                                                    <tr><td style="padding:4px 0;color:#74838E;">Progres</td><td style="padding:4px 0;">
                                                        <div style="display:flex;align-items:center;gap:8px;">
                                                            <div style="flex:1;background:#DCE5ED;border-radius:20px;height:8px;">
                                                        ...
                                                        <div style="font-size:12px;color:#74838E;margin-top:4px;">1 dari 3 tahap selesai</div>
                                                    </td></tr>
                                                </table>
                                            </div>
                                            <div style="text-align:center;margin:24px 0;">
                                            ...
                                            <p style="margin:0;color:#74838E;font-size:13px;">Tim kami akan terus bekerja pada tahapan berikutnya. Kami akan menginformasikan kembali setiap ada tahapan yang selesai.</p>
                                        </div>
                                        <div style="background:#F9FBFD;padding:16px 28px;text-align:center;border-top:1px solid #DCE5ED;">
                                            <div style="font-size:12px;color:#9AA7B2;">© <?= date('Y') ?> <?= htmlspecialchars($prev_site) ?> — Email otomatis, tidak perlu dibalas.</div>
                                        </div>
                            ...
                            <div style="padding:12px 24px;background:#F9FBFD;border-top:1px solid #DCE5ED;font-size:12px;color:#9AA7B2;">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div style="background:linear-gradient(135deg,rgba(220,38,38,0.04),rgba(26,54,93,0.04));border-radius:14px;padding:24px;margin-bottom:24px;border:1px solid rgba(220,38,38,0.1);">
                        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
                            ...
                            <div>
                                <div style="font-weight:700;font-size:14px;color:#12212E;">Ubah Password Admin</div>
                                <div style="font-size:12px;color:#74838E;">
                                    Akun: <strong><?= htmlspecialchars($_SESSION['admin_user'] ?? '') ?></strong>
                                </div>
                            </div>
                        </div>
                        <p style="font-size:13px;color:#74838E;margin:0;">
                    ...
                    <form method="POST" data-loading>
                        ...
                        <div class="mb-4">
                            <label class="form-label" for="old_password">
                                <i class="fas fa-lock me-1" style="color:#74838E;"></i>
                        ...
                        <div class="mb-4">
                            ...
                            <div style="margin-top:8px;">
                                <div style="height:4px;background:#DCE5ED;border-radius:2px;overflow:hidden;">
                                    <div id="strengthBar" style="height:100%;width:0%;transition:all 0.3s;border-radius:2px;"></div>
                                </div>
                                <div id="strengthText" style="font-size:11px;color:#9AA7B2;margin-top:4px;"></div>
                            </div>
                        </div>
