<?php
/**
 * Kayaswara Publishing Website - Web Installer
...
<head>
    ...
    <title>Instalasi - Kayaswara Publishing</title>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(135deg, #1A3C5E 0%, #0F2A45 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<div class="install-card">
    <div class="install-header">
        <div class="mb-2">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="24" cy="20" r="3" fill="rgba(26,60,94,0.8)"/>
            </svg>
        </div>
        <h1>Kayaswara Publishing</h1>
        <p class="mb-0 opacity-75">Instalasi Website Penerbit</p>
    </div>
    <div class="install-body">
        ...
        <div class="text-center py-3">
            ...
            <p class="text-muted mb-4">Website Kayaswara Publishing berhasil diinstal. Anda dapat mulai menggunakan situs dan masuk ke panel admin.</p>
        ...
        <form method="POST" action="install.php?step=2">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="db_name" class="form-control"
                        value="<?= htmlspecialchars($_POST['db_name'] ?? 'kayaswara_publisher') ?>" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Contoh: http://localhost/kayaswara-publisher atau https://kayaswara.co.id</div>
            </div>
