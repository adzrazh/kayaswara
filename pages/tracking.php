...
$pageTitle = 'Tracking Pesanan – ' . getSetting('site_name', 'Kayaswara');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate format: KYSWR-ddMMyyyy-NNN
    if (!preg_match('/^KYSWR-\d{8}-\d{3,}$/i', $trackingCode)) {
        echo json_encode(['success' => false, 'message' => 'Format kode tracking tidak valid. Contoh: KYSWR-06042026-001']);
        exit;
    }
                        ...
                        <div class="tracking-input-group">
                            <div class="tracking-input-wrapper">
                                ...
                                <input type="text"
                                       ...
                                       placeholder="Contoh: KYSWR-06042026-001"
                                       maxlength="25"
                                       required
...
<section class="cta-section">
    <div class="container text-center">
        <div class="fade-in-up">
            ...
            <p class="cta-subtitle" style="color:rgba(255,255,255,0.85);">Mulai konsultasi gratis untuk mendapatkan layanan penerbitan buku terbaik bagi kebutuhan Anda.</p>
